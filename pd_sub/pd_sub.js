...
Component({
    ...
    data: {
        ...
        inputvalue: '',
        index1: 0,
        array1: ['土霉味', '氯味/臭氧味', '草味', '腐败味/沼泽味', '鱼腥味', '芳香味', '药味', '化学品味', '其他'],
        inputvalue1: '',
        ...
        array20: ['霉味', '淤泥味', '土味'],
        array21: ['氯味/臭氧味'],
        array22: ['烟草味', '鲜草味', '干草味', '木材味'],
        array23: ['腐败味', '臭鸡蛋味', '腐烂蔬菜味'],
        array24: ['腥味', '鲜鱼味', '臭鱼味', '藻腥味'],
        array25: ['水果味', '香味', '甜味'],
        array26: ['药味'],
        array27: ['汽油味', '油漆味', '塑料味', '胶水味'],
        array28: ['自定义'],
        inputvalue2: '',
    ...
    methods: {
        ...
        bindPickerChange2: function(e) {
          ...
          var myEventDetail = {
            otherType: '',
            sub_type: e.detail.value, //二级嗅味类型id
